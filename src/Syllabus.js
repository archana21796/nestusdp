        ...
        <div className='row align-items-center justify-content-center '>
          ...
          <div className='col-12 col-xl-8 col-xxl-10 pt-5 row align-items-center justify-content-center '>
              <div className='col-md-8 col-lg-5 col-xl-4'>
                ...
                <div>
                  <h3 className='my-2'>Flexible Credit-Based System</h3>
              ...
              <div className='col-md-8 col-lg-5 col-xl-4'>
                <div className='studbg2 rounded-3 studbg'></div>
                <div>
              ...
              <div className='col-md-8 col-lg-5 col-xl-4'>
                <div className='studbg3 rounded-3 studbg'></div>
                <div>
                  <h3 className='my-2'>Formative Assessments and Reduced Exam Pressure</h3>
              ...
              <div className='col-12 col-md-8 col-xxl-7 row align-items-center justify-content-center txt-center'>
                <div className='col-12 col-md-10 col-lg-7 col-xxl-5 mt-4 mb-5'>
